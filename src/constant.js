...
export const dialogueData = {
  pc: `This is my PC. I work mostly in JavaScript/TypeScript these days.
      I've made a couple of games in that language. I also like Angular and React. Anyway regardless of the framework, I just like programming.
      Here is my <a href="https://github.com/solo-leveler" target="_blank">Github</a>!`,
  ...
  resume: `This is my desk and on it is my resume. <a href="https://solo-leveler.github.io/web-portfolio/assets/files/Ashwin_Peradath_Resume.pdf" target="_blank">Check it out?</a>
    Contact me at ashwindu015@protonmail.com if you have any interesting job opportunities!`,
  ...
  library: `There are a lot of programming books on my shelves. There is even one in French (I also speak Hindi btw).
    I probably only read one of them. Who else compulsively buys technical books without ever finishing them?`,
  exit: `If you want to exit Ashwin's portfolio, just close the tab.`,
};
